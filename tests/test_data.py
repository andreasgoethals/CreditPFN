...
def test_exploration_corpus_summary_shape() -> None:
    ...
    pd_manifest = REPO / "output CreditPFN" / "manifests" / "manifest_pd.csv"
...
def test_exploration_resolves_paths_from_cfg() -> None:
    ...
    cfg = NS(paths=NS(
        ...
        manifest_pd="output CreditPFN/manifests/manifest_pd.csv",
        manifest_lgd="output CreditPFN/manifests/manifest_lgd.csv",
    ))
